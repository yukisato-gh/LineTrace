...
#elif PIN_MODE == 1
#define MOTOR_A1 19U   // Left, OUTA1, phase(正転/逆転)
#define MOTOR_A2 18U   // Left, OUTA2, enable(PWM制御)
#define MOTOR_B1 17U   // Right, OUTB1, phase(正転/逆転)
#define MOTOR_B2 16U   // Right, OUTB2, enable(PWM制御)
#endif

#if PIN_MODE == 0
const uint sens[8] = {2U, 3U, 4U, 5U, 6U, 7U, 8U, 9U}; // センサIN1-IN8(左から順)
#elif PIN_MODE == 1
const uint sens[8] = {15, 14, 13, 12, 11, 10, 9, 8}; // センサIN1-IN8(左から順)
#endif
